...

        {
          typePrint == 1 && <div className='row' style={{height:"300px"}} >
            <div className='position-relative'>
              ...
              {/* section one */}
              <p  style={{position:"absolute",top:"72px" , right:"78px",fontSize:"14px",fontWeight:"bold"}}>{element.name_from_office}</p>
              <p  style={{position:"absolute",top:"72px" , right:"240px",fontSize:"14px",fontWeight:"bold"}}>{element.name_to_office}</p>
              <p  style={{position:"absolute",top:"73px" , right:"414px",fontSize:"14px",fontWeight:"bold"}}>{date.getDate()}</p>
              <p  style={{position:"absolute",top:"73px" , right:"455px",fontSize:"14px",fontWeight:"bold"}}>{date.getMonth() + 1}</p>
              <p  style={{position:"absolute",top:"73px" , right:"495px",fontSize:"16px",fontWeight:"bold"}}>{date.getFullYear().toString().slice(2,4)}</p>
              {/* section tow */}
              <p  style={{position:"absolute",top:"115px" , right:"160px",fontSize:"13px",fontWeight:"bold"}}>{element.name_customer}</p>
              <p  style={{position:"absolute",top:"140px" , right:"160px",fontSize:"13px",fontWeight:"bold"}}>{element.name_to_city}</p>
              <p  style={{position:"absolute",top:"165px" , right:"160px",fontSize:"11px",fontWeight:"bold"}}>{element.content}</p>

              {/* section three */}
              <p  style={{position:"absolute",top:"115px" , right:"480px",fontSize:"13px",fontWeight:"bold"}}>{element.recipient_name}</p>
              <p  style={{position:"absolute",top:"140px" , right:"480px",fontSize:"13px",fontWeight:"bold"}}>{element.recipient_phone_1}</p>
              <p  style={{position:"absolute",top:"165px" , right:"480px",fontSize:"11px",fontWeight:"bold"}}>{element.id}</p>
